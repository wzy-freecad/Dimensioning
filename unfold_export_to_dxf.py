...
def export_via_pstoedit( dxf_fn, V):
    ...
    try:
        ...
        QtWidgets.QMessageBox.information(  FreeCADGui.getMainWindow(), "Success", "%s successfully created" % dxf_fn )
    except RuntimeError as msg:
        QtWidgets.QMessageBox.critical( FreeCADGui.getMainWindow(), "pstoedit failed.", "%s\n\n suggestion: relaunch FreeCAD from BASH and try again." % msg )
